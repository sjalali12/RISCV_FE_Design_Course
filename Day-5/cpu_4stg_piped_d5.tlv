...
\TLV
   ...
   // \====================/
   //
   // Program for MYTH Workshop to test RV32I -- Add 1,2,3,...,9 (in order).
   //
   // Regs:
   ...
   |cpu
      ...
      //Branch_INSTR-Stg-2 Logic
         $br_tgt_pc[31:0] = $pc + $imm ;

     //Source to ALU assign, with output of read register
         $src1_value[31:0] = 
      ...
      //dmem:1-Rd/Wr Memory  ADDR and Enable            
      @4
